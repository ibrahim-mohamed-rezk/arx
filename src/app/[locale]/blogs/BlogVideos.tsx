  ...
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl md:text-2xl font-bold" style={{ fontSize: "clamp(1.25rem, 1vw + 1rem, 1.5rem)" }}>
          OUR NEW VIDEOS
        </h2>
      ...
      <div className="flex flex-col md:flex-row md:space-x-4">
        ...
        <div className="relative w-full md:w-1/2 h-[450px] overflow-hidden rounded-lg shadow-lg mb-4 md:mb-0">
          <div className="relative w-full h-full cursor-pointer" onClick={() => openModal(featuredVideos[0].videoUrl)}>
            <Image
          ...
          {featuredCards.map((card, index) => (
            <div
              ...
              className={`feature-card relative rounded-lg overflow-hidden shadow-md cursor-pointer ${
                hoveredCard === index ? "w-3/5" : hoveredCard === (index === 0 ? 1 : 0) ? "w-2/5" : index === 1 ? "w-3/5" : "w-2/5"
              }`}
