                    ...
                    <div className="w-full max-w-3xl flex flex-col items-center gap-4 md:gap-8">
                        <div className="w-full flex flex-col items-center gap-4">
                            ...
                            <div className="w-full max-w-lg px-3 sm:px-5 py-2 sm:py-3 md:py-4 bg-white rounded-full shadow-lg flex items-center justify-between gap-2">
                                <span className="text-dark-gray  truncate" style={{ fontSize: 'clamp(0.875rem, 3vw, 1.25rem)' }}>
                                    search about projects
                                </span>
                                <div className="flex items-center gap-2">
                                    {/* Filter icon */}
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-actions-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                                    </svg>
                                    {/* Search icon */}
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-dark-gray" fill="none" viewBox="0 0 24 24" stroke="currentColor">
