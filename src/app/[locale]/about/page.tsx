...
const AboutPage: React.FC = () => {
    ...
    const directors = [
        { name: 'Dr. Ahmed Omar', job:t("ahmed_job"), img: "https://storage.googleapis.com/furniture-hub/arx/about_us/2.webp" ,describe:t("ahmed_describe")},
        { name: 'Eng. Yasser Omar', job:t("yasser_job"), img: "https://storage.googleapis.com/furniture-hub/arx/about_us/3%20(1).webp" ,describe:t("yasser_describe")},
        { name: 'Dr. Saad Omar', job:t("saad_job"), img: "https://storage.googleapis.com/furniture-hub/arx/about_us/4.webp" ,describe:t("saad_describe")},
        { name: 'Dr. Osama Omar', job:t("osama_job"), img: "https://storage.googleapis.com/furniture-hub/arx/about_us/1%20(1).webp" ,describe:t("osama_describe")},
    ];
    return (
      <div className="text-gray-800">
          ...
          {[
            {
              title: (
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[clamp(1.5rem,2.5vw,2rem)] font-[Cinzel] font-semibold">
                    {t("vision_title")}
                  </span>
                </div>
              ),
              ...
              image:
                "https://storage.googleapis.com/furniture-hub/arx/about_us/Vision.png",
              reverse: false,
            },
            {
              title: (
              ...
              image:
                "https://storage.googleapis.com/furniture-hub/arx/about_us/mission.png",
              reverse: true,
            },
            {
              title: (
              ...
              image:
                "https://storage.googleapis.com/furniture-hub/arx/about_us/value.png",
              reverse: false,
            },
            ...
            <div
              ...
              } items-center md:gap-8 md:space-x-8 md:space-x-reverse`}
            >
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:space-x-16">
            ...
            <div className="w-full lg:w-1/2 flex justify-center mb-8 lg:mb-0 relative">
              ...
              <div className="absolute flex flex-col items-center justify-center bg-white w-40 h-40 sm:w-48 sm:h-48 rounded-full border border-gray-200">
                <span className="text-[clamp(2rem,5vw,3rem)] font-['Cinzel'] text-blue-800">
                  +20
                </span>
                <p
            ...
            <div className="w-full lg:w-1/2 lg:grid grid-cols-1 gap-8 text-center justify-center items-center flex">
              <div className="flex flex-col items-center">
                <span className="text-[clamp(2rem,4vw,3rem)] font-['Cinzel'] text-[##024064]">
                  2.5K
                  <span className="text-4xl text-yellow-500 pb-50 mb-50">
                    +
                  </span>
                </span>
                <span className="text-bold text-[##060B0E] mt-1">
                  {t("units")}
                </span>
              </div>
              <div className="flex flex-col items-center">
        ...
        <section className="bg-gray-100 py-16 px-4">
          ...
          <div className="max-w-7xl mx-auto grid gap-4 sm:grid-cols-2 lg:grid-cols-4 pb-10 items-stretch text-center">
            {directors.map((dir, i) => (
              <div
                key={i}
                className="bg-white shadow-lg overflow-hidden h-[700px] flex flex-col"
              >
                <div className="h-[400px] relative">
                  <img
                    src={dir.img}
                    alt={dir.name}
                    className="w-full h-full object-cover object-center transition-all duration-300 grayscale hover:grayscale-0 cursor-pointer"
                  />
                </div>
                <div className="p-6 text-start bg-[#060B0E] flex-1 flex flex-col">
                  <h3 className="text-[clamp(1.25rem,2vw,1.5rem)] font-[lato] text-[#fff] font-extrabold mb-2">
                    {dir.name}
                  </h3>
                  <p className="text-[clamp(0.7rem,1.35vw,1.35rem)] font-[lato] text-start text-[#035B8D] flex-1">
                    {dir.job}
                  </p>
                  <p className="text-sm font-[lato] text-start text-[#fff] flex-1">
                    {dir.describe}
                  </p>
                </div>
              </div>
